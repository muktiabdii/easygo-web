...
const Profile = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      const response = await axios.get(
        "https://easygo-api-production-d477.up.railway.app/api/auth/validate-token",
        config
      );
  ...
  const fetchUserReviews = async () => {
    try {
      ...
      const response = await axios.get(
        "https://easygo-api-production-d477.up.railway.app/api/reviews/user",
        config
      );
      if (response.data) {
          ...
          response.data.map(async (review) => {
            try {
              const placeResponse = await axios.get(
                `https://easygo-api-production-d477.up.railway.app/api/places/${review.place_id}`,
                config
              );
              return {
                ...review,
  ...
  const handleSaveProfile = async () => {
    try {
      ...
      const profileResponse = await axios.put(
        "https://easygo-api-production-d477.up.railway.app/api/auth/update",
        updateData,
        {
          ...config,
          headers: {
      ...
      if (selectedImage) {
        ...
        const imageResponse = await axios.post(
          "https://easygo-api-production-d477.up.railway.app/api/auth/update-profile-image",
          imageFormData,
          {
            ...config,
            headers: {
